...
const CustomCheckBox = ({ title, checked, onPress, checkmarkSize = 26, checkmarkPositionX = 1, checkmarkPositionY = -5 }) => {
...
<View style={{ height: checkboxSize, width: checkboxSize, borderRadius: 4, borderWidth: 2, borderColor: checked ? '#007AFF' : '#ccc', justifyContent: 'center', alignItems: 'center', backgroundColor: 'transparent' }}>
{checked && (
